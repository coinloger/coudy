...
function createClient(
	...
	// claude-code: stealth mode для third-party Anthropic-сумісних провайдерів.
	// Ідентичний формат запитів до anthropic, але з headers Claude Code CLI —
	// провайдери (GLM, Kimi тощо) думають, що запит від Claude Code.
