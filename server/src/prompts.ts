	...
	return [
		// Protected default — універсальний асистент, дефолт для нових сесій.
		{
			...
			content: [
				...
				"- Завдання потребує інструментів (read/bash/edit/write/grep/find/ls/fetch) — виконуй таку роботу через logic-блок (block_start → інструменти → block_end).",
				...
				"- Базові тулзи доступні через logic-блок; прості відповіді давай текстом без блоку.",
